...
La pareja ejecuta y completa los tres notebooks de la Parte~2. Como en la Parte~1, y dado
que los notebooks ya están implementados, \textbf{la nota evalúa la comprensión}: las
respuestas a las preguntas conceptuales y la interpretación de los resultados, no la simple
ejecución. La Parte~2 aporta \textbf{10 puntos}.
